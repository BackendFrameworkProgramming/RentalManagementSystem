...
public class EmployeeService {
    ...
    public CommonResponse<Map<String, Object>> updateEmployee(Long id, Map<String, Object> body) {
        ...
        if (body.containsKey("empName")) employee.setEmpName(toString(body.get("empName")));
        if (body.containsKey("empNo")) employee.setEmpNo(toString(body.get("empNo")));
        if (body.containsKey("jobTitle")) employee.setJobTitle(toString(body.get("jobTitle")));
        if (body.containsKey("employmentType")) employee.setEmploymentType(toString(body.get("employmentType")));
        if (body.containsKey("hireDate")) employee.setHireDate(toLocalDate(body.get("hireDate")));
        if (body.containsKey("remark")) employee.setRemark(toString(body.get("remark")));
    ...
    private Map<String, Object> toMap(Employee employee) {
        ...
        map.put("teamId", employee.getTeam().getId());
    ...
    private Long toLong(Object value) {
        if (value == null) throw new CustomException("INVALID_REQUEST", "필수 값이 누락되었습니다.");
